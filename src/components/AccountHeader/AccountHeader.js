        ...
        <header className='account-header'>
            ...
            <div className="account-header__navbar-container">
                ...
                <li className='account-header__burger-item'><Link className={isMovies(location) === 'main' ? `account-header__burger-link account-header__burger-link_chosen` : `account-header__burger-link`} to={props.routeLinks.main}>Главная</Link></li>
                    ...
                    <li className='account-header__burger-item'><Link className={isMovies(location) === 'saved-movies' ? `account-header__burger-link account-header__burger-link_chosen` : `account-header__burger-link`} to={props.routeLinks.savedMovies}>Сохраненные фильмы</Link></li>
            ...
            <div className='account-header__full-navi'>
                <div className='account-header__links-container'>
                    ...
                    <Link className={isMovies(location) === 'saved-movies' ? `account-header__movies-btn account-header__movies-btn_chosen` : `account-header__movies-btn`} to={props.routeLinks.savedMovies}>Сохраненные фильмы</Link>  
                </div>

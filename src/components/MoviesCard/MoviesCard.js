...
function MoviesCard(props) {
    ...
    return (
        <div className='movie-card'>
            ...
            <a className='movie-card__img-link' href={props.item.trailerLink} target="_blank" rel='noreferrer'><img className='movie-card__img' src={imgUrl(props)} alt='Переход к трейлеру'/></a>
        </div>
    );
}
